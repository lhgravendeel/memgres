...
/**
 * Test runner for the pg18_sample_sql_4 suite.
 *
...
class Pg18SampleSql4Test {
    ...
    private static Path findSuiteDir() {
        try {
            java.net.URL url = Pg18SampleSql4Test.class.getClassLoader().getResource("pg18-sql-4");
            if (url != null) return Path.of(url.toURI());
        } catch (Exception ignored) {}
        throw new RuntimeException("Cannot find pg18-sql-4 resource directory");
    }
}
