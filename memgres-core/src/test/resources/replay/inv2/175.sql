...
-- finding: 175
-- title: CREATE AGGREGATE validates only that SFUNC and STYPE are present plus the arity of two functions; STYPE is never resolved as a type, FINALFUNC_EXTRA is not allo
-- begin-expected
-- ok: 0
-- end-expected
