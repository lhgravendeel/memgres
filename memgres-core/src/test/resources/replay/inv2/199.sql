...
-- finding: 199
-- title: CALL and DO have no transaction frame of their own: executeCall's finally commits whenever the status is IN_TRANSACTION, whether or not the CALL opened it; PL/p
-- begin-expected
-- ok: 0
-- end-expected
