...
-- finding: 367
-- title: Every container type has a hand-written text writer whose escape rules its own reader does not share: hstore emits the value between quotes with no escaping whi
-- begin-expected
-- ok: 0
-- end-expected
