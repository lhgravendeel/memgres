...
-- finding: 357
-- title: The six system column names are answered before any FROM item is consulted. RowContext.resolveColumn intercepts tableoid and ctid/xmin/xmax/cmin/cmax ahead of t
-- begin-expected
-- ok: 0
-- end-expected
