...
-- finding: 361
-- title: The tail of a SELECT is parsed as a run of individually-optional keywords. Inside the FOR loop every word after the lock strength is a matchKeyword free to fail
-- begin-expected
-- ok: 0
-- end-expected
