...
-- begin-expected-error
-- sqlstate: 42501
-- message-like: must be owner of table zz_own
-- end-expected-error
ALTER TABLE zz_own DISABLE ROW LEVEL SECURITY;
-- begin-expected-error
-- sqlstate: 42501
-- message-like: must be owner of table zz_own
-- end-expected-error
ALTER TABLE zz_own ADD COLUMN extra int;
-- begin-expected-error
-- sqlstate: 42501
-- message-like: must be owner of table zz_own
-- end-expected-error
CREATE INDEX zz_ix ON zz_own (id);
-- begin-expected-error
-- sqlstate: 42501
-- message-like: must be owner of table zz_own
-- end-expected-error
COMMENT ON TABLE zz_own IS 'x';
...
-- end-expected-error
CREATE TRIGGER zz_tg5d AFTER INSERT ON zz_t5 DEFERRABLE INITIALLY DEFERRED FOR EACH ROW EXECUTE FUNCTION zz_f5();
