...
-- finding: 219
-- title: WHERE CURRENT OF is a value comparison against the first matching row of whatever table the statement names: filterByCurrentOf never checks that the cursor's qu
-- begin-expected
-- ok: 0
-- end-expected
