...
-- finding: 270
-- title: Every list-valued clause in the security DDL grammar keeps one element and drops the rest — sometimes as a syntax error, more often silently. The GRANT object l
-- begin-expected
-- ok: 0
-- end-expected
...
-- begin-expected
-- columns: sel_id:text | sel_n:text
-- row: true | false
-- rowcount: 1
-- end-expected
SELECT has_column_privilege('zz_r3','zz_t2','id','SELECT')::text AS sel_id,
       has_column_privilege('zz_r3','zz_t2','n','SELECT')::text AS sel_n;
-- begin-expected
-- ok: 0
-- end-expected
CREATE ROLE zz_g1;
