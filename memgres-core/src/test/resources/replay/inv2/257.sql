...
-- finding: 257
-- title: Loop bodies never poll for cancellation. executeLoop is `while (true) { executeStatements(...) }`; the only cancellation check in the engine sits in expression 
-- begin-expected
-- ok: 0
-- end-expected
