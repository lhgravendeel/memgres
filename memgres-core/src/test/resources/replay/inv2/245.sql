...
-- finding: 245
-- title: The whole-table DELETE fast path fires no triggers at all: the stmt.where()==null branch runs handleFkOnDelete, recordDeleteUndo and deleteAll but never execute
-- begin-expected
-- ok: 0
-- end-expected
