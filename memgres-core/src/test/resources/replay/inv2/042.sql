...
-- finding: 42
-- title: A value is admitted into a JSON document on a guess about its spelling, never a parse: jsonValueStr accepts anything Double.parseDouble takes (NaN, Infinity, 1d
