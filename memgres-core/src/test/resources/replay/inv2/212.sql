...
-- finding: 212
-- title: Statement-context gates ask session.isInTransaction(), which a DO block's implicit transaction leaves false — the same guard the August report named for LOCK TA
