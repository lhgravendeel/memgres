...
-- finding: 17
-- title: Every `[...]` in an expression is lowered to BinaryExpr(expr, JSON_SUBSCRIPT, idx). Array subscripting then inherits jsonb's rules: a non-integer index is refus
...
-- end-expected-error
SELECT ('[10,20,30]'::jsonb) -> 4294967296;
-- begin-expected-error
-- sqlstate: 42883
-- message-like: operator does not exist: jsonb -> bigint
-- end-expected-error
