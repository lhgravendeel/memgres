...
-- finding: 298
-- title: pg_default_acl is a statement log rather than an ACL catalog: a flat List appended to once per statement, rendered one row per element with memgres's own column
-- begin-expected
-- ok: 0
-- end-expected
CREATE ROLE zz_a;
