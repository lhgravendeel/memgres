...
-- finding: 174
-- title: CREATE OPERATOR, CREATE OPERATOR CLASS, CREATE OPERATOR FAMILY and ALTER OPERATOR FAMILY copy their clauses onto the stored object without resolving the access 
