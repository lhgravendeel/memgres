...
-- finding: 87
-- title: MERGE is a second, thinner DML implementation: executeMergeInner repeats none of the guards the INSERT/UPDATE/DELETE paths run (read-only, privilege, WITH CHECK
-- begin-expected
-- ok: 0
-- end-expected
