...
-- finding: 259
-- title: A row value becomes field-addressable only on the assignment path, and only for a declared type that names its fields. The DECLARE path calls scope.declareTyped
-- begin-expected
-- ok: 0
-- end-expected
