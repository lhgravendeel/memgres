...
-- finding: 62
-- title: encode/decode delegate to java.util.Base64 and to per-Java-char byte casts instead of implementing PostgreSQL's codecs: no 76-column wrapping, whitespace strict
-- begin-expected
-- columns: encode:text
-- row: c3a9
-- rowcount: 1
...
-- rowcount: 1
-- end-expected
SELECT length(encode(decode(repeat('61', 1000), 'hex'), 'base64'));
-- begin-expected
-- columns: encode:text
-- row: 61626364
-- rowcount: 1
...
-- end-expected-error
SELECT encode(decode('xy','hex'),'hex');
