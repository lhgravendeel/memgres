...
-- finding: 376
-- title: An inheritance child stores the parent's own mutable Column instances, and child/partition rows are mapped into the parent by position; getAllRows also skips th
-- begin-expected
-- ok: 0
-- end-expected
...
-- begin-expected
-- columns: attstorage:char
-- row: x
-- rowcount: 1
-- end-expected
SELECT at.attstorage FROM pg_attribute at JOIN pg_class c ON c.oid = at.attrelid WHERE c.relname='zz_vf2_sp' AND at.attname='a';
-- begin-expected
-- ok: 0
-- end-expected
