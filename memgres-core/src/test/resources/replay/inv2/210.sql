...
-- finding: 210
-- title: PREPARE stores an AST, not an analysed plan: the accepted-body test is a six-way instanceof whitelist, the parameter check is a per-node walk, and nothing recor
-- begin-expected
-- ok: 0
-- end-expected
