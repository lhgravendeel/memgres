...
-- finding: 183
-- title: SqlUnparser.binOpToSql's default arm returns op.name(), so eighteen operators are deparsed as Java enum constants; RuleDeparser.operatorText has all of them, so
