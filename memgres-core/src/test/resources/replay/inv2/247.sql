...
-- finding: 247
-- title: An INSTEAD OF DELETE trigger is handed the live base row as both NEW and OLD, and executeTriggerFunctionCall copies the returned OLD map back over that same arr
-- begin-expected
-- ok: 0
-- end-expected
