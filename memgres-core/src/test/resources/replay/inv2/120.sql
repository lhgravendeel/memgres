...
-- finding: 120
-- title: Several object maps are keyed by bare name or by the session's default schema instead of by the object's own schema, so cross-schema operations hit the wrong ob
-- begin-expected
-- ok: 0
-- end-expected
