...
-- finding: 76
-- title: The geometric input functions are regex scrapes: they check only that they found at least the components they need, never require the whole literal to be consum
