...
-- finding: 220
-- title: a foreign key is copied to a partition only if it is a PRIMARY KEY or a UNIQUE constraint, so the leaf enforces nothing and the referenced table's inbound-FK sc
-- begin-expected
-- ok: 0
-- end-expected
