...
-- finding: 358
-- title: The per-row MVCC metadata is a stub. setRowInsertMeta/setRowUpdateMeta write {xmin, 0, cmin, 0, ctid}: xmax and cmax are literal zeros never written again; cmin
-- begin-expected
-- ok: 0
-- end-expected
