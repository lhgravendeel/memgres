...
-- finding: 253
-- title: Each DML write path re-implements the SET loop, so the GENERATED ALWAYS guard exists on one of four; applySetClauses does carry a copy but its error arm opens w
-- begin-expected
-- ok: 0
-- end-expected
