...
-- finding: 18
-- title: RangeOperations.build() applies the discrete canonicalisation before comparing the bounds, and successor() adds 1 to a long with no overflow check; the range ar
...
-- rowcount: 1
-- end-expected
SELECT '(1,10]'::numrange - '(5,10]'::numrange;
-- begin-expected
