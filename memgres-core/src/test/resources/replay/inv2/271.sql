...
-- finding: 271
-- title: Security DDL never validates what it names. parseRoleOptions's default branch is a bare `return;`, so an unrecognised role option ends parsing and the statement
-- begin-expected
-- ok: 0
-- end-expected
...
-- end-expected-error
GRANT SELECT ON ALL TABLES IN SCHEMA zz_nosuchschema TO zz_gr1;
-- begin-expected-error
-- sqlstate: 3F000
-- message-like: schema "zz_nosuchschema" does not exist
-- end-expected-error
REVOKE USAGE ON SCHEMA zz_nosuchschema FROM zz_gr1;
-- begin-expected-error
-- sqlstate: 42704
