...
-- finding: 206
-- title: role is a GUC string, not a role reference: SET ROLE writes guc.set("role", <next token>) with no catalog lookup, three hardcoded names are whitelisted, the opt
-- begin-expected
-- ok: 0
-- end-expected
CREATE ROLE zz_r2;
