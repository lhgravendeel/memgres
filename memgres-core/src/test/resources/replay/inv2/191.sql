...
-- finding: 191
-- title: "Cannot run inside a transaction block" and "cannot run in a read-only transaction" are ad-hoc lists — the read-only gate matches on Java class-name prefixes an
-- begin-expected
-- ok: 0
-- end-expected
