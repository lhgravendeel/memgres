...
-- finding: 13
-- title: MERGE's UPDATE arm commits with System.arraycopy(newRow, 0, targetRow, 0, …) straight onto the live row, so no index is updated. A primary key changed by MERGE 
-- begin-expected
-- ok: 0
-- end-expected
