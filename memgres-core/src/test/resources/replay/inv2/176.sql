...
-- finding: 176
-- title: the extension statements have no availability list to check a name against, no version registry, no pg_depend record, no undo entry, and a pg_extension builder 
-- begin-expected
-- ok: 0
-- end-expected
