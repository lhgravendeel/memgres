...
-- finding: 211
-- title: DROP OWNED BY and ALTER DEFAULT PRIVILEGES touch ownership only: executeDropOwned drops the relations the role owns without scanning dependencies, without honou
-- begin-expected
-- ok: 0
-- end-expected
CREATE ROLE zz_a;
