...
-- finding: 179
-- title: FULL JOIN admissibility and USING type compatibility are decided from hand-written enum lists that omit every container, array, jsonb, text-search and geometric
