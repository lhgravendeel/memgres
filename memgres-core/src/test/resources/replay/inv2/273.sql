...
-- finding: 273
-- title: RLS bypass is decided from superuser/owner alone and gated on the FORCE flag for both. PostgreSQL exempts a superuser unconditionally (FORCE only removes the ow
-- begin-expected
-- ok: 0
-- end-expected
