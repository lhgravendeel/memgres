...
-- finding: 276
-- title: The name-resolution helpers do not consult search_path: to_regclass searches every schema, operator resolution always searches pg_catalog and public, a pg_catal
-- begin-expected
-- ok: 0
-- end-expected
CREATE SCHEMA zz_s3;
