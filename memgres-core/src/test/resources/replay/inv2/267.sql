...
-- finding: 267
-- title: Authorisation is only ever decided by one function, and it only knows about table-level grants. AstExecutor.checkTablePrivilege consults hasPrivilegeDirectOrInh
-- begin-expected
-- ok: 0
-- end-expected
