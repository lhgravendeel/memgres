...
-- finding: 263
-- title: Failures during argument and typmod evaluation are caught and replaced by a default. A parameter default that raises becomes NULL; a declared length that does n
-- begin-expected
-- ok: 0
-- end-expected
