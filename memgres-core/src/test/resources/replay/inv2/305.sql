...
-- finding: 305
-- title: pg_description is re-synthesised from the comment map by a switch that knows nine object kinds and returns null for the rest; pg_shdescription is hardcoded empt
-- begin-expected
-- ok: 0
-- end-expected
