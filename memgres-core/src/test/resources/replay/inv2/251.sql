...
-- finding: 251
-- title: A deferred constraint is only deferred inside an explicit transaction block: checkIsCurrentlyDeferred requires session.isInTransaction(), so in autocommit every
-- begin-expected
-- ok: 0
-- end-expected
