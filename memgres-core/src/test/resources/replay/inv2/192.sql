...
-- finding: 192
-- title: The wire layer works out what a FETCH or EXECUTE returns by string-matching the uppercased SQL text, so any spelling its scraper misses (the bare FETCH form, a 
-- begin-expected
-- ok: 0
-- end-expected
