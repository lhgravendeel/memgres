...
-- finding: 169
-- title: the catalog rows describing a column's type, collation and partition operator class are written as constants rather than from the declared definition, so pg_dum
-- begin-expected
-- ok: 0
-- end-expected
