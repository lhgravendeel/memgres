...
-- finding: 137
-- title: Row-level security is applied only where rows are filtered out of a scan; the RETURNING projection is not gated on the SELECT policies, and any exception raised
-- begin-expected
-- ok: 0
-- end-expected
