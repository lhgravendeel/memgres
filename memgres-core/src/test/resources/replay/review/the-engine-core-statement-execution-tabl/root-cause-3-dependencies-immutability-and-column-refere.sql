...
-- finding: Root cause 3: dependencies, immutability and column references are decided by searching SQL text
-- area: The engine core: statement execution, tables, windows, joins and deparsing
-- title: Root cause 3: dependencies, immutability and column references are decided by searching SQL text
-- begin-expected
-- ok: 0
-- end-expected
...
-- ok: 0
-- end-expected
CREATE FUNCTION zz_vf2_xf() RETURNS int LANGUAGE plpgsql AS $$
DECLARE v zz_vf2_x.a%TYPE; BEGIN v := 1; RETURN v; END $$;
-- begin-expected
-- ok: 0
-- end-expected
DROP TABLE zz_vf2_x;
