...
-- finding: Root cause 4: a DDL statement's side effects are not scoped to what it named
-- area: The engine core: statement execution, tables, windows, joins and deparsing
-- title: Root cause 4: a DDL statement's side effects are not scoped to what it named
-- begin-expected
-- ok: 0
-- end-expected
...
-- rowcount: 1
-- end-expected
SELECT nextval('zz_vf2_seqt_id_seq') AS n;
...
-- end-expected-error
SELECT nextval('zz_vf2_s_id_seq') AS n;
-- begin-expected
-- ok: 0
-- end-expected
