...
-- finding: Root cause 5: the sequence-to-owning-column dependency is not modelled
-- area: Joins, CTEs, subqueries — and the DDL that came with them
-- title: Root cause 5: the sequence-to-owning-column dependency is not modelled
-- begin-expected
-- ok: 0
-- end-expected
