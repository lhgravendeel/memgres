...
-- finding: Root cause 1: DDL mutates live structures without recording an undo entry
-- area: Joins, CTEs, subqueries — and the DDL that came with them
-- title: Root cause 1: DDL mutates live structures without recording an undo entry
-- begin-expected
-- ok: 0
-- end-expected
