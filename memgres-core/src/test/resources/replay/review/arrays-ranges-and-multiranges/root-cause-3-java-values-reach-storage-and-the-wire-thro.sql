...
-- finding: Root cause 3: Java values reach storage and the wire through `toString()`
-- area: Arrays, ranges and multiranges
-- title: Root cause 3: Java values reach storage and the wire through `toString()`
-- begin-expected
-- ok: 0
-- end-expected
