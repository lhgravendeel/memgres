...
-- finding: Root cause 2: a composite on its way into a column is written by a third writer that quotes nothing, and read back by a splitter that never un-escapes
-- area: Round-trip and equality invariants
-- title: Root cause 2: a composite on its way into a column is written by a third writer that quotes nothing, and read back by a splitter that never un-escapes
-- begin-expected
-- ok: 0
-- end-expected
