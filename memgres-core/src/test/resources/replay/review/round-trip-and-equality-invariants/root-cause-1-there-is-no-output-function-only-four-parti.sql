...
-- finding: Root cause 1: there is no output function, only four partial re-implementations that fall back to `Object.toString()`
-- area: Round-trip and equality invariants
-- title: Root cause 1: there is no output function, only four partial re-implementations that fall back to `Object.toString()`
-- begin-expected
-- columns: a1:text
-- row: {t}
-- rowcount: 1
