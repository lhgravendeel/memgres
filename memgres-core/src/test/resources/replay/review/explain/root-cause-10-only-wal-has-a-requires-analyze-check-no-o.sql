...
-- finding: Root cause 10: only WAL has a requires-ANALYZE check; no other option pair is validated
-- area: EXPLAIN
-- title: Root cause 10: only WAL has a requires-ANALYZE check; no other option pair is validated
