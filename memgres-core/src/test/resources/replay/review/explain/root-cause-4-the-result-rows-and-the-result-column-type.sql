...
-- finding: Root cause 4: the result rows and the result column type are assembled from the text lines after the fact
-- area: EXPLAIN
-- title: Root cause 4: the result rows and the result column type are assembled from the text lines after the fact
...
-- ResultSetMetaData.getColumnTypeName(1) on the EXPLAIN result
-- begin-expected
-- columns: QUERY PLAN:json
-- row: [\n  {\n    "Plan": {\n      "Node Type": "Result",\n      "Parallel Aware": false,\n      "Async Capable": false,\n      "Disabled": false\n    }\n  }\n]
-- rowcount: 1
