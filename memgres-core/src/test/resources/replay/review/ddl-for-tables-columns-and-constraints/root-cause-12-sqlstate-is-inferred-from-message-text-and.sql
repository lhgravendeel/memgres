...
-- finding: Root cause 12: SQLSTATE is inferred from message text, and object-kind is not distinguished from object-absence
-- area: DDL for tables, columns and constraints
-- title: Root cause 12: SQLSTATE is inferred from message text, and object-kind is not distinguished from object-absence
-- begin-expected
-- ok: 0
-- end-expected
