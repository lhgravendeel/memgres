...
-- finding: Root cause 7: identifiers and expressions are matched as substrings of SQL text
-- area: DDL for tables, columns and constraints
-- title: Root cause 7: identifiers and expressions are matched as substrings of SQL text
-- begin-expected
-- ok: 0
-- end-expected
