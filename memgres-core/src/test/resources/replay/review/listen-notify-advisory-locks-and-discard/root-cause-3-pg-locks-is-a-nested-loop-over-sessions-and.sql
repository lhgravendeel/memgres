...
-- finding: Root cause 3: pg_locks is a nested loop over sessions and tables, not a view of the lock manager
-- area: LISTEN/NOTIFY, advisory locks and DISCARD
-- title: Root cause 3: pg_locks is a nested loop over sessions and tables, not a view of the lock manager
-- begin-expected
-- ok: 0
-- end-expected
