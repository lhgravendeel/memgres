...
-- finding: Root cause 5: tid, xid and cid are not types — they are text and integers wearing a name
-- area: System columns, row locking and TABLESAMPLE
-- title: Root cause 5: tid, xid and cid are not types — they are text and integers wearing a name
-- begin-expected
-- columns: ?column?:bool
-- row: t
-- rowcount: 1
