...
-- finding: Root cause 1: SKIP LOCKED decides a row is locked when it is not in the named relation's own row list
-- area: System columns, row locking and TABLESAMPLE
-- title: Root cause 1: SKIP LOCKED decides a row is locked when it is not in the named relation's own row list
-- begin-expected
-- ok: 0
-- end-expected
