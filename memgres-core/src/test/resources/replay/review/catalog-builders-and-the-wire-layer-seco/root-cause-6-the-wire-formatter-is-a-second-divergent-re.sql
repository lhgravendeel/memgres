...
-- finding: Root cause 6: the wire formatter is a second, divergent renderer of PostgreSQL's output syntax
-- area: Catalog builders and the wire layer, second pass
-- title: Root cause 6: the wire formatter is a second, divergent renderer of PostgreSQL's output syntax
-- begin-expected
-- ok: 0
-- end-expected
SET TIME ZONE 'UTC';
