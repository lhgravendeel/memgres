...
-- finding: Root cause 11: definition-time query errors are re-thrown on two of the three view paths
-- area: The parsers
-- title: Root cause 11: definition-time query errors are re-thrown on two of the three view paths
-- begin-expected
-- ok: 0
-- end-expected
