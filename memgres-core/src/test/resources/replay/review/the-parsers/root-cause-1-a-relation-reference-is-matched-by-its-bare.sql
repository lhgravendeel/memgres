...
-- finding: Root cause 1: a relation reference is matched by its bare name, with no schema and no scope
-- area: The parsers
-- title: Root cause 1: a relation reference is matched by its bare name, with no schema and no scope
-- begin-expected
-- ok: 0
-- end-expected
