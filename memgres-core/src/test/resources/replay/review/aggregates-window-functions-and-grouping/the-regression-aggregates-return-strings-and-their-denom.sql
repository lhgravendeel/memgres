...
-- finding: The regression aggregates return strings, and their denominator is built from two doubles
-- area: Aggregates, window functions and grouping
-- title: The regression aggregates return strings, and their denominator is built from two doubles
-- begin-expected
