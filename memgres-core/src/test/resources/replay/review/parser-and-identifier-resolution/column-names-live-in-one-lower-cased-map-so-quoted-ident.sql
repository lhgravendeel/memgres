...
-- finding: Column names live in one lower-cased map, so quoted identifiers carry no meaning
-- area: Parser and identifier resolution
-- title: Column names live in one lower-cased map, so quoted identifiers carry no meaning
-- begin-expected
-- ok: 0
-- end-expected
