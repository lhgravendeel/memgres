...
-- finding: Schema qualifiers are dropped by the parser or carried into a lookup that cannot use them
-- area: Parser and identifier resolution
-- title: Schema qualifiers are dropped by the parser or carried into a lookup that cannot use them
-- begin-expected
-- ok: 0
-- end-expected
CREATE SCHEMA zz_s2;
