...
-- finding: Root cause 1: a multi-statement simple Query is executed as N independent autocommit statements
-- area: Transactions, sessions, cursors and locks
-- title: Root cause 1: a multi-statement simple Query is executed as N independent autocommit statements
-- begin-expected
-- ok: 0
-- end-expected
