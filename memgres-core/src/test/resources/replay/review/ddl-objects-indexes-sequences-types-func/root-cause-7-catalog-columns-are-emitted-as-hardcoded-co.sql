...
-- finding: Root cause 7: catalog columns are emitted as hardcoded constants
-- area: DDL objects: indexes, sequences, types, functions, triggers, rules, views, partitioning and the catalogs that describe them
-- title: Root cause 7: catalog columns are emitted as hardcoded constants
-- begin-expected
-- ok: 0
-- end-expected
...
-- sqlstate: 42P01
-- message-like: relation "zz_vf_x1" does not exist
-- end-expected-error
