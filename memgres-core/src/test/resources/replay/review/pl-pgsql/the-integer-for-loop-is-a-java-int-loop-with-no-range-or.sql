...
-- finding: The integer FOR loop is a Java `int` loop with no range or overflow check
-- area: PL/pgSQL
-- title: The integer FOR loop is a Java `int` loop with no range or overflow check
-- begin-expected
-- ok: 0
-- end-expected
