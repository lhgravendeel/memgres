...
-- finding: A function's result shape is derived from the value that came back, not from the declaration
-- area: PL/pgSQL
-- title: A function's result shape is derived from the value that came back, not from the declaration
-- begin-expected
-- ok: 0
-- end-expected
