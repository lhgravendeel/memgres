...
-- finding: Root cause 3: a PREPARE's declared parameter list is an I/O cast applied at EXECUTE, not a type contract fixed at PREPARE
-- area: PREPARE, EXECUTE, DO and CALL
-- title: Root cause 3: a PREPARE's declared parameter list is an I/O cast applied at EXECUTE, not a type contract fixed at PREPARE
-- begin-expected
-- ok: 0
-- end-expected
