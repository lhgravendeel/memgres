...
-- finding: Root cause 17: the DO grammar reads two tokens and discards them, and the body is never compiled
-- area: PREPARE, EXECUTE, DO and CALL
-- title: Root cause 17: the DO grammar reads two tokens and discards them, and the body is never compiled
