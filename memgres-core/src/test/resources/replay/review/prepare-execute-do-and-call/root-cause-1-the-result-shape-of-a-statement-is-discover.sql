...
-- finding: Root cause 1: the result shape of a statement is discovered by executing the statement
-- area: PREPARE, EXECUTE, DO and CALL
-- title: Root cause 1: the result shape of a statement is discovered by executing the statement
-- JDBC ...?prepareThreshold=1, sent as a PreparedStatement:
...
-- no FETCH at all; session B, with SET lock_timeout='2000ms'
-- begin-expected-error
-- sqlstate: 42P01
-- message-like: relation "zz_vf2_cl" does not exist
-- end-expected-error
