...
-- finding: Root cause 16: COMMENT is one if/else chain over object kinds that resolves almost nothing
-- area: PREPARE, EXECUTE, DO and CALL
-- title: Root cause 16: COMMENT is one if/else chain over object kinds that resolves almost nothing
