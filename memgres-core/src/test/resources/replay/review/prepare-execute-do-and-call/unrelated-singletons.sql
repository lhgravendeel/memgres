...
-- begin-expected-error
-- sqlstate: 42601
-- message-like: syntax error at or near "NOTHING"
-- end-expected-error
DISCARD NOTHING;
-- begin-expected-error
-- sqlstate: 42601
...
-- end-expected-error
ALTER STATISTICS zz_vf2_st1 SET STATISTICS 99999999999;
-- begin-expected-error
-- sqlstate: 22023
-- message-like: statistics target -5 is too low
-- end-expected-error
ALTER STATISTICS zz_vf2_st1 SET STATISTICS -5;
-- begin-expected
-- ok: 0
-- end-expected
BEGIN;
-- begin-expected-error
-- sqlstate: 42P01
-- message-like: relation "zz_vf2_fc" does not exist
-- end-expected-error
DECLARE zz_vf2_x1 CURSOR FOR SELECT i FROM zz_vf2_fc ORDER BY i;
-- begin-expected-error
-- sqlstate: 42601
-- message-like: syntax error at or near "3000000000"
-- end-expected-error
FETCH 3000000000 FROM zz_vf2_x1;
-- begin-expected-error
-- sqlstate: 42P01
-- message-like: relation "zz_bc_t" does not exist
-- end-expected-error
SELECT 1 FROM zz_bc_t WHERE 1::int + 1::real;
-- begin-expected-error
-- sqlstate: 42883
-- message-like: operator does not exist: integer >> bigint
-- end-expected-error
SELECT 1 WHERE 1::int >> 1::bigint;
-- begin-expected-error
-- sqlstate: 42601
-- message-like: invalid range bound flags
-- end-expected-error
SELECT int4range(1, 2, 'x');
-- begin-expected-error
-- sqlstate: 42601
-- message-like: invalid range bound flags
-- end-expected-error
