...
-- finding: Root cause 7: the cursor statements are matched keyword by keyword in a fixed order, and never required to end
-- area: SQL-level cursors
-- title: Root cause 7: the cursor statements are matched keyword by keyword in a fixed order, and never required to end
