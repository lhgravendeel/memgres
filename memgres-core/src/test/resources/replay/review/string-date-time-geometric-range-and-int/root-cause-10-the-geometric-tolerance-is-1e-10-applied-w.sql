...
-- finding: Root cause 10: the geometric tolerance is 1e-10, applied where PostgreSQL uses FPeq at 1e-6 and where it tests for exact zero
-- area: String, date/time, geometric, range and interval implementations
-- title: Root cause 10: the geometric tolerance is 1e-10, applied where PostgreSQL uses FPeq at 1e-6 and where it tests for exact zero
-- begin-expected
