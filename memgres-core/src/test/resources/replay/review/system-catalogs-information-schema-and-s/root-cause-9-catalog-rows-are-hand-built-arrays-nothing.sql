...
-- finding: Root cause 9: catalog rows are hand-built arrays nothing checks against the declared columns
-- area: System catalogs, information_schema and security
-- title: Root cause 9: catalog rows are hand-built arrays nothing checks against the declared columns
-- begin-expected
