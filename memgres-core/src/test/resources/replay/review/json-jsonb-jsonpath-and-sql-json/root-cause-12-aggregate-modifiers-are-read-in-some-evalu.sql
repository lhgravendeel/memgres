...
-- finding: Root cause 12: aggregate modifiers are read in some evaluator branches only
-- area: JSON, JSONB, jsonpath and SQL/JSON
-- title: Root cause 12: aggregate modifiers are read in some evaluator branches only
-- begin-expected
