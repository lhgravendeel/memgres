...
-- finding: Root cause 5: RowDescription metadata comes from a narrow DataType enum, not a type catalog
-- area: Wire protocol and error-report fidelity
-- title: Root cause 5: RowDescription metadata comes from a narrow DataType enum, not a type catalog
