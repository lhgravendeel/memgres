...
-- finding: Root cause 8: the write paths walk a table's partitions but not its inheritance children
-- area: Isolation, deadlocks and features in combination
-- title: Root cause 8: the write paths walk a table's partitions but not its inheritance children
-- begin-expected
-- ok: 0
-- end-expected
