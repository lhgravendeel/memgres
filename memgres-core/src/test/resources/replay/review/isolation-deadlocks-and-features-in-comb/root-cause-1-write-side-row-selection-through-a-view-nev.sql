...
-- finding: Root cause 1: write-side row selection through a view never looks at the view's WHERE
-- area: Isolation, deadlocks and features in combination
-- title: Root cause 1: write-side row selection through a view never looks at the view's WHERE
-- begin-expected
-- ok: 0
-- end-expected
