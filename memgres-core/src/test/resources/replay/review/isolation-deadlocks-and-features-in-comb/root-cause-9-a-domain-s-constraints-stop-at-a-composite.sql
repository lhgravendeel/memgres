...
-- finding: Root cause 9: a domain's constraints stop at a composite-type boundary, and a composite type is not a resolvable base type
-- area: Isolation, deadlocks and features in combination
-- title: Root cause 9: a domain's constraints stop at a composite-type boundary, and a composite type is not a resolvable base type
-- begin-expected
-- ok: 0
-- end-expected
