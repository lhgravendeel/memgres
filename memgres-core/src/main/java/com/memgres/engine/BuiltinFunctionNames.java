...
public final class BuiltinFunctionNames {
    ...
    static final String[] NAMES = {
            ...
            "current_user", "user", "currval", "date", "date_add", "date_bin", "date_part",
            "date_subtract", "date_trunc", "decode", "defined", "delete",
            ...
            "interval", "isclosed", "isvertical", "ishorizontal", "isparallel", "isperp", "isdefined", "isexists", "isfinite", "isopen",
            ...
            "pg_char_to_encoding", "pg_describe_object", "pg_drop_replication_slot",
            "pg_encoding_to_char", "pg_relation_filenode", "pg_settings_get_flags",
            ...
            "pg_get_indexdef", "pg_get_keywords", "pg_get_function_arg_default", "pg_identify_object", "pg_isolation_test_session_is_blocked", "pg_collation_actual_version", "pg_get_statisticsobjdef", "pg_get_partkeydef", "pg_get_ruledef",
            "pg_get_acl",
            ...
            "pg_log_backend_memory_contexts", "pg_ls_archive_statusdir", "pg_ls_dir", "pg_ls_logdir", "pg_lsn_larger", "pg_lsn_smaller",
    ...
    private static final String[] ALSO_CALLABLE = {
            ...
            "jsonb_object", "jsonb_object_agg", "jsonb_agg_strict", "jsonb_object_agg_strict",
            "jsonb_object_agg_unique", "jsonb_object_agg_unique_strict",
            ...
            "word_similarity", "strict_word_similarity", "row_security_active",
            "to_regnamespace", "pg_opfamily_is_visible", "makeaclitem",
