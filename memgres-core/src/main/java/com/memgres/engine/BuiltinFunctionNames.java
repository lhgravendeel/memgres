...
final class BuiltinFunctionNames {
    ...
    static final String[] NAMES = {
            ...
            "array_to_string", "array_to_tsvector", "array_upper", "ascii", "avals", "avg", "bf",
            "bigint", "bigserial", "bit", "bit_and", "bit_length", "bit_or", "bit_xor", "bool",
            "bool_and", "bool_or", "boolean", "bound_box", "box", "btrim", "bytea", "can_multi_col",
            "can_order", "can_unique", "cardinality", "ceil", "ceiling", "center", "centuries",
            "century", "char", "char_length", "character", "character_length", "chr", "cidr", "circle",
            "clock_timestamp", "closest_point", "cmin", "coalesce", "col_description", "concat",
            "concat_ws", "convert", "count", "crc32", "crc32c", "ctid", "cube", "cube_dim",
            "current_catalog", "current_database", "current_date", "current_query", "current_role",
            "current_schema", "current_schemas", "current_setting", "current_time",
            "current_timestamp", "current_user", "currval", "date", "date_bin", "date_part",
            "date_trunc", "day", "days", "decade", "decades", "decimal", "decode", "defined", "delete",
            "delete_key", "dense_rank", "des", "diagonal", "diameter", "div", "dow", "doy", "each",
            ...
            "has_type_privilege", "height", "hour", "hours", "hstore", "hstore_to_array",
            "hstore_to_json", "hstore_to_json_loose", "hstore_to_jsonb", "hstore_to_jsonb_loose",
            "hstore_to_matrix", "icu_unicode_version", "inet", "inet_client_addr", "inet_client_port",
            "inet_server_addr", "inet_server_port", "initcap", "int", "int2", "int4", "int8",
            "integer", "intersects", "interval", "is_horizontal", "is_parallel", "is_perpendicular",
            "is_vertical", "isclosed", "isdefined", "isexists", "isfinite", "isodow", "isopen",
            "isoyear", "json", "json_agg", "json_array_constructor", "json_array_elements",
            "json_array_elements_text", "json_array_length", "json_array_subquery", "json_build_array",
            "json_build_object", "json_each", "json_extract_path", "json_extract_path_text",
            "json_object_constructor", "json_object_keys", "json_scalar", "json_serialize",
            "json_typeof", "jsonb", "jsonb_agg", "jsonb_array_elements", "jsonb_array_elements_text",
            ...
            "jsonb_pretty", "jsonb_set", "jsonb_set_lax", "jsonb_typeof", "julian", "justify_days",
            ...
            "min", "mins", "minute", "minutes", "mod", "month", "months", "name", "nextval",
            "normalize", "now", "npoints", "nth_value", "ntile", "nullif", "num_nonnulls", "num_nulls",
            "numeric", "numnode", "obj_description", "octet_length", "oid", "overlaps", "overlay",
            "path", "pb", "pclose", "pg_advisory_lock", "pg_advisory_unlock", "pg_advisory_xact_lock",
            ...
            "quarter", "querytree", "quote_ident", "quote_literal", "quote_nullable", "radius",
            "raise_exception", "random", "rank", "real", "regclass", "regexp_count", "regexp_instr",
            "regexp_like", "regexp_match", "regexp_matches", "regexp_replace", "regexp_split_to_array",
            "regexp_substr", "regproc", "regprocedure", "regtype", "repeat", "replace",
            "return_target", "reverse", "right", "round", "row", "row_number", "rpad", "rtrim",
            "second", "seconds", "secs", "serial", "session_user", "set_config", "setseed", "setval",
            "setweight", "sha1", "sha224", "sha256", "sha384", "sha512", "shobj_description", "sign",
            "skeys", "slice", "slope", "smallint", "split_part", "sqrt", "starts_with",
            "statement_timestamp", "string_agg", "string_to_array", "strip", "strpos", "substr",
            "substring", "substring_similar", "sum", "svals", "tableoid", "tb", "text", "time",
            "timeofday", "timestamp", "timestamptz", "timetz", "timezone", "timezone_hour",
            "timezone_minute", "to_char", "to_date", "to_hex", "to_number", "to_regclass",
            "to_regproc", "to_regprocedure", "to_regtype", "to_timestamp", "to_tsquery", "to_tsvector",
            "transaction_timestamp", "translate", "trim", "trim_array", "trunc", "ts_debug",
            "ts_delete", "ts_filter", "ts_headline", "ts_lexize", "ts_parse", "ts_rank", "ts_rank_cd",
            "ts_rewrite", "ts_stat", "ts_token_type", "tsquery", "tsquery_phrase", "tsvector",
            "tsvector_to_array", "txid_current", "txid_current_if_assigned", "txid_current_snapshot",
            "txid_snapshot_xip", "txid_snapshot_xmax", "txid_snapshot_xmin", "txid_status", "unicode",
            "unistr", "unnest", "upper", "use_json_null", "uuid", "uuidv7", "varbit", "varchar",
            "version", "websearch_to_tsquery", "week", "weeks", "width", "xdes", "xmin", "xml", "year",
            "years"
    };
}
