...
public class GucSettings {
    ...
    private static final String[][] SETTING_DEFS = {
            ...
            {"autovacuum_vacuum_max_threshold", "100000000", "integer", "sighup", "Vacuuming / Automatic Vacuuming", null, "-1", "2147483647", null, "Maximum number of tuple updates or deletes prior to vacuum."},
